...
public class ImpressaoAlunos {
    ...
    private static ArrayList<Aluno> selecionarAlunos() {
        ...
        String filtro_prefix;
        
        System.out.println("Digite o prefixo para filtro ou tecle enter: ");
        filtro_prefix = leitura.nextLine();
        ...
        System.out.println("---Filtros de selecao: alunos nascidos entre: "
                ...
                " e o prefixo : " + filtro_prefix + "\n");
        return filtrarAlunos(ano_inicial, ano_final, estado_civil, filtro_prefix);
    }

    private static ArrayList<Aluno> filtrarAlunos(int ano_inicial, int ano_final, Aluno.EstadoCivil estado_civil, String filtro_prefix) {
        ...
        for (int n=0; n<alunos.length; n++){
         ...
         if((ano_nascimento >= ano_inicial)&&(ano_nascimento <= ano_final)
                 ...
                 (alunos[n].getnome().startsWith(filtro_prefix))){
